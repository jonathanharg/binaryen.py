...
BinaryenExpressionId BinaryenTableFillId(void);
BinaryenExpressionId BinaryenTableCopyId(void);
BinaryenExpressionId BinaryenTryId(void);
BinaryenExpressionId BinaryenTryTableId(void);
BinaryenExpressionId BinaryenThrowId(void);
BinaryenExpressionId BinaryenRethrowId(void);
BinaryenExpressionId BinaryenThrowRefId(void);
...
BinaryenExpressionId BinaryenContNewId(void);
BinaryenExpressionId BinaryenResumeId(void);
...
struct BinaryenLiteral { uintptr_t type;
union { int32_t i32;
int64_t i64;
float f32;
double f64;
...
BinaryenExpressionRef BinaryenArrayNewData(BinaryenModuleRef module, BinaryenHeapType type, const char* name, BinaryenExpressionRef offset, BinaryenExpressionRef size);
...
void BinaryenSetMemory(BinaryenModuleRef module, BinaryenIndex initial, BinaryenIndex maximum, const char* exportName, const char** segmentNames, const char** segmentDatas, bool* segmentPassives, BinaryenExpressionRef* segmentOffsets, BinaryenIndex* segmentSizes, BinaryenIndex numSegments, bool shared, bool memory64, const char* name);
...
uint32_t BinaryenGetMemorySegmentByteOffset( BinaryenModuleRef module, const char* segmentName);
size_t BinaryenGetMemorySegmentByteLength(BinaryenModuleRef module, const char* segmentName);
bool BinaryenGetMemorySegmentPassive(BinaryenModuleRef module, const char* segmentName);
void BinaryenCopyMemorySegmentData(BinaryenModuleRef module, const char* segmentName, char* buffer);
...
typedef struct BinaryenBufferSizes { size_t outputBytes;
...
typedef struct BinaryenModuleAllocateAndWriteResult { void* binary;
size_t binaryBytes;
char* sourceMap;
...
BinaryenIndex BinaryenFunctionAddVar(BinaryenFunctionRef func, BinaryenType type);

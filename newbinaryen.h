...
BinaryenHeapTypeGetBottom(BinaryenHeapType heapType);
 _Bool BinaryenHeapTypeIsSubType(BinaryenHeapType left,
...
BinaryenStructTypeGetFieldType(BinaryenHeapType heapType, BinaryenIndex index);
 ...
 _Bool BinaryenStructTypeIsFieldMutable(BinaryenHeapType heapType,
                                                   BinaryenIndex index);
 BinaryenType
...
BinaryenMemoryCopy(BinaryenModuleRef module,
                   ...
                   BinaryenExpressionRef size,
                   __const char* destMemory,
                   __const char* sourceMemory);
 BinaryenExpressionRef
...
// expression.
 __const char* BinaryenSwitchGetNameAt(BinaryenExpressionRef expr,
                                                 BinaryenIndex index);
...
// all subsequent names one index down. Returns the name.
 __const char* BinaryenSwitchRemoveNameAt(BinaryenExpressionRef expr,
                                                    BinaryenIndex index);
...
// all subsequent catch tags one index down. Returns the tag.
 __const char* BinaryenTryRemoveCatchTagAt(BinaryenExpressionRef expr,
                                                     BinaryenIndex index);
...
// the existing entity is turned into an import.
 ...
 void BinaryenAddFunctionImport(BinaryenModuleRef module,
                                            __const char* internalName,
                                            __const char* externalModuleName,
                                            __const char* externalBaseName,
                                            BinaryenType params,
                                            BinaryenType results);
...
__attribute__((deprecated)) BinaryenExportRef BinaryenAddExport(BinaryenModuleRef module,
                                                    __const char* internalName,
                                                    __const char* externalName);
...
// size in segmentSizes. exportName can be ((void*)0)
 void BinaryenSetMemory(BinaryenModuleRef module,
                                    BinaryenIndex initial,
                                    BinaryenIndex maximum,
                                    __const char* exportName,
                                    __const char** segments,
                                    _Bool* segmentPassive,
 ...
 BinaryenIndex BinaryenMemoryGetInitial(BinaryenModuleRef module,
                                                    __const char* name);
 _Bool BinaryenMemoryHasMax(BinaryenModuleRef module,
                                       __const char* name);
 BinaryenIndex BinaryenMemoryGetMax(BinaryenModuleRef module,
                                                __const char* name);
 __const char* BinaryenMemoryImportGetModule(BinaryenModuleRef module,
                                                       __const char* name);
 __const char* BinaryenMemoryImportGetBase(BinaryenModuleRef module,
                                                     __const char* name);
 _Bool BinaryenMemoryIsShared(BinaryenModuleRef module,
                                         __const char* name);
 _Bool BinaryenMemoryIs64(BinaryenModuleRef module,
                                     __const char* name);
...
BinaryenGetMemorySegmentByteOffset(BinaryenModuleRef module, BinaryenIndex id);
 size_t BinaryenGetMemorySegmentByteLength(BinaryenModuleRef module,
                                                       BinaryenIndex id);
 _Bool BinaryenGetMemorySegmentPassive(BinaryenModuleRef module,
                                                  BinaryenIndex id);
...
// Tests if the local at the specified index has a name.
 _Bool BinaryenFunctionHasLocalName(BinaryenFunctionRef func,
                                               BinaryenIndex index);
// Gets the name of the local at the specified index.
 __const char* BinaryenFunctionGetLocalName(BinaryenFunctionRef func,
                                                      BinaryenIndex index);
...
// expression actually evaluates to a constant.
 _Bool ExpressionRunnerSetLocalValue(ExpressionRunnerRef runner,
                                                BinaryenIndex index,
                                                BinaryenExpressionRef value);
...
// will also happen (not affected by any flags). Returns `1` if the
// expression actually evaluates to a constant.
 _Bool ExpressionRunnerSetGlobalValue(ExpressionRunnerRef runner,
                                                 __const char* name,
                                                 BinaryenExpressionRef value);
